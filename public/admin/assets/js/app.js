        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    name: 'MetronicApp',
                    files: [
                        'assets/js/controllers/AuthenticationController.js'
                    ]
                }]);
            }]
        }
            ...
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        ...
                        'assets/js/controllers/DashboardActivityController.js'
                    ]
                });
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    name: 'MetronicApp',
                    files: [
                        'assets/js/controllers/ClientController.js'
                    ]
                }]);
            }]
        }
            ...
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    ...
                    files: [
                        ...
                        'assets/js/controllers/DomainController.js'
                    ]
                }]);
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    ...
                    insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                    files: [
                        'assets/js/controllers/GatewayLogsController.js'
                    ]
                }]);
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    ...
                    insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                    files: [
                        'assets/js/controllers/SupportController.js'
                    ]
                }]);
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load([{
                    ...
                    insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                    files: [
                        'assets/js/controllers/AdministratorController.js'
                    ]
                }]);
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        'assets/js/moment.min.js',
                        'assets/js/controllers/ReportController.js'
                    ]
                });
            }]
        }
            ...
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        ...
                        'assets/js/components-pickers.js',
                        'assets/js/moment.min.js',
                        'assets/js/controllers/ClientsReportController.js'
                    ]
                });
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        'assets/js/moment.min.js',
                        'assets/js/controllers/CartController.js'
                    ]
                });
            }]
        }
            ...
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        ...
                        'assets/js/controllers/OrderController.js'
                    ]
                });
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        'assets/js/moment.min.js',
                        'assets/js/controllers/Affiliates.js'
                    ]
                });
            }]
        }
        ...
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        'assets/js/moment.min.js',
                        'assets/js/controllers/ClientdataController.js'
                    ]
                });
            }]
        }
            ...
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        ...
                        'assets/js/moment.min.js',
                        'assets/js/controllers/AffiliatesSettingsController.js'
                    ]
                });
            }]
        }
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'assets/js/controllers/ClientprofileController.js'
                        ]
                    });
                }]
            }
