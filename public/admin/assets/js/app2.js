...
MetronicApp.factory('settings', ['$rootScope', function($rootScope) {
    ...
    var settings = {
        ...
        layoutImgPath: Metronic.getAssetsPath() + 'assets/images/',
...
MetronicApp.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('searchClient', {
            url: "/search-client.html",
            templateUrl: "views/search-client.html",
            data: {pageTitle: 'Search Client'},
        ...
        .state('addClient', {
            ...
            data: {pageTitle: 'Add a New Client'},
            controller: "GeneralPageController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('domainReg', {
            url: "/domainReg.html",
            templateUrl: "views/domainReg.html",
            data: {pageTitle: 'Domain Registration'},
            controller: "GeneralPageController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('cancelReq', {
            url: "/cancel-req.html",
            templateUrl: "views/cancel-req.html",
            data: {pageTitle: 'Cancellation Request'},
            controller: "GeneralPageController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('massMail', {
            url: "/mass-mail.html",
            templateUrl: "views/mass-mail.html",
            data: {pageTitle: 'Mass Mail'},
            controller: "GeneralPageController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        .state('manageOrder', {
            ...
            templateUrl: "views/manage-order.html",
        ...
        .state('billTrans', {
            url: "/bill-trans.html",
            templateUrl: "views/bill-trans.html",
            data: {pageTitle: 'Transcation'},
            controller: "GeneralPageController",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
        ...
        // BILLING - INVOICES
        .state('billInvoice', {
            url: "/bill-invoice.html",
            templateUrl: "views/bill-invoice.html",
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'assets/js/components-pickers.js',
                            'assets/js/components-dropdowns.js',
        ...
        // individualResult
        .state('individualResult', {
            url: "/individualResult.html",
            templateUrl: "views/individualResult.html",
            data: {pageTitle: 'Individual Result'},
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'assets/js/angularjs/plugins/ui-select/select.min.css',
                            'assets/js/angularjs/plugins/ui-select/select.min.js'
                        ] 
                    }, {
                        name: 'MetronicApp',
                        files: [
