...
BillingApp.config(['$stateProvider', '$urlRouterProvider', '$httpProvider', function($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    $stateProvider
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'assets/js/lib/bootstrap-datepicker.js',
                            'assets/js/lib/select2.min.js',

                            'assets/js/lib/index.js',

                            'assets/js/controllers/authentication/signup.js'
                        ]
                    });
                }]
            }
        ...
        .state('code', {
            ...
            templateUrl: "views/authentication/token.html",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'BillingApp',
                        ...
                        files: [
                            ...
                            'assets/js/controllers/authentication/token.js'
                        ]
                    });
                }]
            }
        ...
        .state('ackcode', {
            ...
            templateUrl: "views/authentication/ackcode.html",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'BillingApp',
                        ...
                        files: [
                            ...
                            'assets/js/controllers/authentication/ackcode.js'
                        ]
                    });
                }]
            }
    ...
    .state('message', {
        ...
        templateUrl: "views/authentication/message.html",
        resolve: {
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    name: 'BillingApp',
                    ...
                    files: [
                        ...
                        'assets/js/controllers/authentication/message.js'
                    ]
                });
            }]
        }
            ...
            deps: ['$ocLazyLoad', function($ocLazyLoad) {
                return $ocLazyLoad.load({
                    ...
                    files: [
                        ...
                        'assets/js/controllers/dashboard/TodoController.js'
                    ]
                });
            }]
        }
    ...
    .state('welcome', {
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'assets/js/controllers/dashboard/GeneralPageController.js'
                        ]
                    });
                }]
            }
        ...
        .state('forgot', {
            url: "/forgot",
            templateUrl: "views/authentication/forgotpassword.html",
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'assets/js/controllers/authentication/fpass.js'
                        ]
                    });
                }]
            }
        ...
        .state('rpassword', {
            ...
            templateUrl: "views/authentication/rcode.html",
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        name: 'BillingApp',
                        ...
                        files: [
                            ...
                            'assets/js/controllers/authentication/rpassword.js'
                        ]
                    });
                }]
            }
